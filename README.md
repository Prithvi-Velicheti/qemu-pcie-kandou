...
Perform MMIO, DMA, interrupts etc. 

The long term goal (needs to be done) of the project is to instantiate two such devices, perform P2P DMA, test BIOS enumeration etc. 
